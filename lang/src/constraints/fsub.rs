...
impl ResolveConstraint for FSub {
    fn resolve(
        &self,
        ...
        let (s_bit_count, exp_bit_count, mant_bit_count) = match self.operand_bitwidth {
            ...
            _ => panic!(
                "Unsupported self.operand_bitwidth {} for FSub S/E/M decomposition.",
        ...
        let op2_s_expr =
            fp_logical_not(&op2_s_original_expr, ctx, constraints, "op2_s_flipped_fsub");
        ...
        let op1_is_pos_inf = fp_logical_and(
            &op1_is_inf,
            &fp_is_value_zero(&op1_s_expr, ctx, constraints, "op1_s_is_zero_fsub"),
            ctx,
            constraints,
            "op1_is_pos_inf_fsub",
        );
        let op1_is_neg_inf = fp_logical_and(
            &op1_is_inf,
            &fp_logical_not(
                &fp_is_value_zero(&op1_s_expr, ctx, constraints, "op1_s_is_zero_for_neg_fsub"),
                ctx,
                constraints,
                "op1_s_is_one_fsub",
            ),
        ...
        let op2_is_pos_inf_effective = fp_logical_and(
            ...
            &fp_is_value_zero(&op2_s_expr, ctx, constraints, "op2_s_flipped_is_zero_fsub"),
            ctx,
            constraints,
        ...
        let op1_is_inf_not_nan = fp_logical_and(
            &op1_is_inf,
            &fp_logical_not(&op1_is_nan, ctx, constraints, "op1_not_nan_fsub"),
            ctx,
            constraints,
        ...
        let op2_is_inf_eff_not_nan = fp_logical_and(
            &op2_is_inf_original_sign,
            &fp_logical_not(&op2_is_nan, ctx, constraints, "op2_not_nan_fsub"),
            ctx,
            constraints,
        ...
        let op1_is_pos_inf_not_nan = fp_logical_and(
            &op1_is_pos_inf,
            &fp_logical_not(&op1_is_nan, ctx, constraints, "op1_pos_inf_nn_aux1_fsub"),
            ctx,
            constraints,
            "op1_pos_inf_nn_fsub",
        );
        ...
        let op1_is_neg_inf_not_nan = fp_logical_and(
            &op1_is_neg_inf,
            &fp_logical_not(&op1_is_nan, ctx, constraints, "op1_neg_inf_nn_aux1_fsub"),
            ctx,
            constraints,
            "op1_neg_inf_nn_fsub",
        );
        ...
        let op1_is_zero_not_special = fp_logical_and(
            &op1_is_true_zero,
            &fp_logical_not(&op1_is_nan, ctx, constraints, "op1_not_nan_z_fsub"),
            ctx,
            constraints,
        ...
        let op1_is_zero_not_special = fp_logical_and(
            ...
            &fp_logical_not(&op1_is_inf, ctx, constraints, "op1_not_inf_z_fsub"),
            ctx,
            constraints,
        ...
        let op2_is_zero_not_special = fp_logical_and(
            &op2_is_true_zero,
            &fp_logical_not(&op2_is_nan, ctx, constraints, "op2_not_nan_z_fsub"),
            ctx,
            constraints,
        ...
        let not_special_scenario_intermediate1 =
            fp_logical_not(&final_res_is_nan, ctx, constraints, "not_nan_for_gen_fsub");
        ...
        let implicit_bit_val_op1 =
            fp_logical_not(&op1_is_denormal, ctx, constraints, "op1_implicit_bit_fsub");
        let implicit_bit_val_op2 =
            fp_logical_not(&op2_is_denormal, ctx, constraints, "op2_implicit_bit_fsub");
        ...
        let exp_diff = fp_sub(&e1_eff, &e2_eff, ctx, constraints, "exp_diff_fsub");
        ...
        let effective_op_is_sub =
            fp_icmp_neq(&s1_orig, &s2_orig, ctx, constraints, "eff_op_is_sub_fsub");
